...
function selectChoice(player, choice) {
  ...
  playerButtons.forEach(btn => {
    ...
    // Remove inline styles from unselected buttons
  ...
  // Add selected to the clicked button with immediate visual feedback
  ...
  if (selectedBtn) {
    // Force style update
    selectedBtn.style.transition = 'none';
    selectedBtn.classList.add('selected');
    
    // Add inline styles as backup to ensure it shows
    selectedBtn.style.background = 'linear-gradient(135deg, #a29bfe 0%, #6c5ce7 100%)';
    selectedBtn.style.border = '3px solid #6c5ce7';
    selectedBtn.style.color = 'white';
    selectedBtn.style.boxShadow = '0 6px 20px rgba(108, 92, 231, 0.5), 0 0 0 4px rgba(108, 92, 231, 0.4)';
    
    // Trigger reflow to ensure style is applied
